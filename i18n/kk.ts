...
export const kk = {
  ...
  goalNew: {
    ...
    action: 'Қанша әрекет керек',
    actionHint: 'Пайыз тек осыдан есептеледі',
    unitLabel: 'Бірлігі',
    ...
    resultTo: 'Мақсат',
    resultUnit: 'Бірлік',
    resultNote: 'Нәтиже пайызға қатыспайды. Салмақ түспеуі мүмкін, бірақ жоспарланған жаттығудың бәрін жасасаңыз — пайыз 100%.',
