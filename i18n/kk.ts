...
export const kk = {
  ...
  goal: {
    ...
    timeAll: 'Барлығы',
    timeNone: 'уақыт жазылмаған',
    timeEmpty:
      'Бұл мақсатқа әлі таймер қосылмаған. Фокус таймерін әрекетке байласаңыз, уақыт осында жиналады.',
    timeWeekEmpty: 'Бұл аптада таймер қосылмаған.',
    timeWeekEmptyNow: 'Осы аптада әлі таймер қосылмады.',
    prevWeek: 'Өткен апта',
