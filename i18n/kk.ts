...
export const kk = {
  ...
  goal: {
    ...
    action: 'Әрекет',
    /** Балалары жоқ мақсат 0% КӨРСЕТПЕЙДІ (CLAUDE.md §5.2b) */
    undivided: 'Бөлінбеген',
    undividedNote: 'Бұл мақсат әлі кезеңдерге бөлінбеген. Пайыз кезеңдерден жиналады — соларды қоспайынша есептейтін ештеңе жоқ.',
    addStage: '+ Кезең қосу',
  },
  ...
  /** Кезең / ай формасы — ТОЛЫҚ форма (CLAUDE.md §5.2b) */
  stageNew: {
    title: 'ЖАҢА КЕЗЕҢ',
    what: 'Кезеңнің аты',
    ...
    amount: 'Көлемі',
    amountHint: 'Пайыз тек осыдан есептеледі',
    ...
    /** Есептелген салдар — өзгертілмейді, тек көрсетіледі */
    consequence: '{weeks} апта → {date} бітеді',
    noRhythm: 'Көлем мен ырғақты қойсаңыз, қашан бітетіні осында шығады.',

    /** Ата-ана мерзімінен асқанда */
    overWarning: 'Ырғағыңыз мерзімнен {n} апта асып тұр',
    optPerWeek: 'Аптасына {n} рет',
    optMoveDeadline: 'Мерзімді жылжыту',
    optReduceAmount: 'Көлемді азайту',
    optNote: 'Ешқайсысы автоматты қолданылмайды — өзіңіз таңдайсыз.',

    create: 'Кезең қосу',
    daysMismatch: 'Таңдалған күн саны ырғақпен сәйкес емес — бұл қате емес, жай ғана хабар.',
  },
