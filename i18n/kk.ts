...
export const kk = {
  ...
  nav: {
    ...
    myNotes: 'Менің ойларым',
    focus: 'Фокус',
    habits: 'Әдеттер',
    weekly: 'Апта қорытындысы',
    time: 'Уақыт есебі',
    notes: 'Менің ойларым',
    deadlines: 'Мерзімдер',
    settings: 'Баптау',
  ...
  signIn: {
    ...
    demo: 'Тест режимімен кіру',
    demoDesc: 'Тіркелусіз бірден платформаны көру',
    demoModeActive: 'Тест режимі (Демо)',
    rateLimitHelp: 'Supabase тегін пошта лимитіне жетті. Supabase-те «Confirm email» баптауын өшіріңіз немесе төмендегі «Тест режимімен кіру» батырмасын басыңыз.',
    errors: {
  ...
  /** Апта қорытындысы — аптаның не болғанын санайды, жоспар құрмайды */
  week: {
    title: 'АПТА ҚОРЫТЫНДЫСЫ',
    range: '{n}-апта · {from} — {to}',
    prev: 'Өткен апта',
    next: 'Келесі апта',
    thisWeek: 'ОСЫ АПТА',
    done: 'Орындалды',
    missed: 'Қалып қойды',
    ahead: 'Алда тұрғаны',
    focus: 'Фокуста өткен уақыт',
    habits: 'Әдеттер',
    prevWas: 'Өткен аптада {pct}% болатын',
    /** Салыстыруға өткен аптада әрекет болмаған */
    noCompare: 'Салыстыруға өткен аптада әрекет болмаған.',
    /** ⚠ Жүйе өзі көшірмейді де, жаппайды да — адам шешеді */
    whatNext: 'Қалып қойғанын не істейміз?',
    moveOn: 'Көшіру',
    close: 'Жабу',
    closeHint:
      'Көшіру — келесі аптаның сол күніне. Жабу — пайыз есебінен шығарады, бірақ жоспарлағаныңыз тарихта қалады.',
    lesson: 'Аптаның сабағы',
    lessonPlaceholder: 'Осы аптаның басты сабағы не болды?',
    lessonEdit: 'Сабақты өңдеу',
    lessonWrite: 'Сабақ жазу',
    lessonEmpty: 'Бұрынғы сабақтар әлі жоқ',
    /** Түйме жоқ: жазғаныңыз өзі сақталады */
    lessonAuto: 'Жазғаныңыз өзі сақталады',
    lessonSaving: 'Сақталуда…',
    lessonSaved: 'Сақталды',
    /** Бірінші жол тақырып: ол бос болса, тізімде осы тұрады */
    lessonUntitled: 'Атаусыз',
  },
  ...
  goal: {
    ...
    /** Мақсатты аяқтау — адамның шешімі, пайыздың салдары емес */
    finish: 'Мақсатты аяқтау',
  ...
  habits: {
    ...
    /** ⚠ Бұл ҚАЗІРГІ серия. Рекорд бөлек жолда тұрады. */
    currentStreak: 'ҚАЗІРГІ ҮЗІЛІССІЗ СЕРИЯ',
    record: 'рекорд {n}',
  ...
  time: {
    title: 'УАҚЫТ',
    allTime: 'Бүкіл уақыт',
    /** Экранның басты сұрағы: жалпы қанша уақыт кетті */
    totalLabel: 'Мақсаттарға кеткен уақыт',
    sessionsWord: 'сессия',
    byGoal: 'Мақсаттар бойынша',
    byAction: 'Қай әрекетке кетті',
    goalTotal: 'Осы мақсатқа барлығы',
    weekMode: 'Апта',
    monthMode: 'Ай',
    now: 'ОСЫ КЕЗЕҢ',
    prev: 'Алдыңғы кезең',
    next: 'Келесі кезең',
    prevWeekWas: 'Өткен аптада',
    prevMonthWas: 'Өткен айда',
    /** Кезең әлі бітпесе өткен күндерге ғана бөлінеді */
    perDay: 'КҮНІНЕ ОРТАША',
    periodTotal: 'БАРЛЫҒЫ',
    /** Салыстыруға алдыңғы кезеңнің дерегі жетпеді — нөл деп жазу жаңылтады */
    noCompare: 'Салыстыруға дерек әлі жеткіліксіз.',
    empty: 'Таймермен жазылған уақыт әлі жоқ.',
    emptyPeriod: 'Бұл кезеңде таймер қосылмаған.',
  ...
  archive: {
    ...
    average: 'орт. {pct}%',
    /** ⚠ Макетте деңгей бойынша еді; апта деңгейі жойылған соң мағына бойынша */
    filters: {
      all: 'Бәрі',
      actions: 'Әрекеттер',
      goals: 'Мақсаттар',
    ...
    levelYear: 'Жыл',
    droppedChip: 'Жабылды',
    empty: 'Бұл сүзгіге сәйкес жазба әлі жоқ.',
    more: 'Тағы {n} көрсету',
    stats: {
      tasks: 'Аяқталған\nәрекет',
  ...
  motto: {
    ...
    onHome: 'БАСТЫ БЕТТЕ',
    add: 'Өз сөзімді қосу',
    placeholder: 'Өзіңізге не айтасыз?',
    previewEmpty: 'Мұнда сіздің сөзіңіз тұрады.',
    rotating: 'КҮН САЙЫН АУЫСАДЫ',
    emptyTitle: 'Әлі сөз жоқ',
    /** ⚠ Жүйе дайын дәйексөз ұсынбайды — бұл адамның өз сөзі */
    emptyText:
      'Дайын дәйексөз ұсынбаймыз. Бұл — өзіңізге айтқан сөзіңіз: біреудің афоризмі емес, өз уәдеңіз.',
  },
  ...
  notes: {
    ...
    bodyPlaceholder: 'Не ойлап жүрсіз?',
    drawHint: 'Сурет салу үшін қалам не маркерді таңдаңыз.',
    undo: 'Соңғы сызықты қайтару',
    search: 'Іздеу',
    ...
    saving: 'Сақталуда…',
    saved: 'Сақталды',
    emptyTitle: 'Жазба әлі жоқ',
    /** ⚠ Мұнда пайыз да, мерзім де жоқ — ой есеп берілетін нәрсе емес */
    emptyText:
      'Мұнда пайыз да, мерзім де жоқ. Ой — есеп берілетін нәрсе емес: жазыңыз, сызыңыз, сол жеткілікті.',
  },
  ...
  admin: {
    title: 'ӘКІМШІ ПАНЕЛІ',
    subtitle: 'Жүйені басқару және статистика',
    tabOverview: 'Шолу',
    tabUsers: 'Қолданушылар',
    tabAnalytics: 'Аналитика',
    tabMottos: 'Дәйексөздер',
    tabAnnounce: 'Хабарландыру',
    statsTotalUsers: 'Барлық қолданушы',
    statsActiveToday: 'Бүгінгі белсенді',
    statsGoals: 'Барлық мақсаттар',
    statsHabits: 'Белсенді әдеттер',
    statsCompletion: 'Орындалу деңгейі',
    statsFocus: 'Фокус уақыты',
    analyticsTitle: 'Қолданушылар белсенділігі мен уақыт аналитикасы',
    onlineNow: 'Қазір онлайн',
    onlineCount: '{n} қолданушы',
    activeUsersList: 'Белсенді қолданушылар',
    statusOnline: 'Онлайн',
    statusOffline: 'Оффлайн',
    lastSeen: 'Соңғы белсенділік',
    justNow: 'Жаңа ғана',
    minutesAgo: '{n} мин бұрын',
    hoursAgo: '{n} сағ бұрын',
    todayTime: 'Бүгінгі уақыт',
    totalTimeSpent: 'Жалпы жұмсалған уақыт',
    avgSessionDuration: 'Орташа сессия',
    focusProductiveTime: 'Фокус (өнімді) уақыт',
    peakHoursTitle: 'Тәуліктік белсенді сағаттар',
    peakHoursDesc: 'Қолданушылардың жүйеге ең көп кіретін мезгілі',
    sectionDistribution: 'Бөлімдер бойынша уақыт үлесі',
    secHome: 'Басты бет',
    secCalendar: 'Күнтізбе',
    secFocus: 'Фокус таймері',
    secHabits: 'Әдеттер',
    secNotes: 'Жазбалар',
    secGoals: 'Мақсаттар',
    hoursCount: '{n} сағат',
    minutesCount: '{n} минут',
    userActivityRanking: 'Ең белсенді қолданушылар',
    userColEmail: 'Email',
    userColName: 'Аты-жөні',
    userColJoined: 'Тіркелген күні',
    userColGoals: 'Мақсаттар',
    userColHabits: 'Әдеттер',
    userSearchPlaceholder: 'Email немесе аты бойынша іздеу...',
    noUsersFound: 'Қолданушылар табылмады',
    usersFound: '{n} қолданушы табылды',
    mottoAddTitle: 'Жаңа дәйексөз қосу',
    mottoTextPlaceholder: 'Мотивациялық сөзді жазыңыз...',
    mottoActive: 'Белсенді',
    mottoInactive: 'Өшірулі',
    mottoStatus: 'Күйі',
    announceTitle: 'Басты бетке хабарландыру баннері',
    announcePlaceholder: 'Хабарландыру мәтінін жазыңыз...',
    announceEnabled: 'Баннерді көрсету',
    announceDisabled: 'Баннер жасырулы',
    announceSaved: 'Хабарландыру сақталды',
    announcePreview: 'Алдын ала көрініс',
    adminAccessOnly: 'Бұл бөлімге тек жүйе әкімшісі кіре алады.',
    goToApp: 'Қосымшаға оралу',
    systemHealthy: 'Жүйе дұрыс жұмыс істеп тұр',
