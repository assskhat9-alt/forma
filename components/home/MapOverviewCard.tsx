...
export function MapOverviewCard({
  ...
  return (
    <Card radius={22} style={styles.card}>
      <Pressable onPress={onExpand} style={styles.head} accessibilityRole="button">
      ...
      <View style={styles.mapArea}>
        ...
        <View style={styles.zoomControls}>
          <Pressable onPress={zoomIn} style={styles.zoomBtn} accessibilityRole="button" accessibilityLabel="Үлкейту">
            <PlusIcon size={12} color={C.ink2} strokeWidth={2.4} />
          </Pressable>
          <View style={styles.zoomDivider} />
          <Pressable onPress={zoomOut} style={styles.zoomBtn} accessibilityRole="button" accessibilityLabel="Кішірейту">
      ...
      {/* ── Төменгі көрсеткіш ── */}
      <Pressable onPress={onExpand} style={styles.footRow} accessibilityRole="button">
